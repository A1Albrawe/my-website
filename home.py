...
<style>
    ...
    /* 🌐 شريط الهيدر العلوي القياسي الموحد: الاسم يميناً وعنده ضغط يعود للرئيسية، وزر القائمة يساراً */
    ...
    .brand-logo { font-size: 24px; font-weight: bold; color: #fff; text-shadow: 0 0 8px #58a6ff; font-family: monospace; text-decoration: none; margin: 0; padding: 0; cursor: pointer; }
    ...
    /* 💻 التصميم ثنائي الأجنحة المتجاوب بكفاءة تامة تملأ شاشات الكمبيوتر واللاب توب بالبكسل */
    ...
    /* 🔒 الذيل المغلق الحصين الموحد لجميع الصفحات */
...
<body>
    ...
    <div class="top-nav">
        <!-- الاسم يميناً، وعند النقر المباشر عليه يعود بك كلياً للصفحة الرئيسية الموحدة -->
        <a href="/" class="brand-logo">Albrawe</a>
        <!-- زر استدعاء وحقن الستارة الجانبية من ملف menu حياً وبدون وميض -->
        <button class="menu-btn-trigger" onclick="loadAndOpenSidebarMenu()"><i class="fas fa-bars"></i> القائمة</button>
    </div>

    <!-- صندوق الحاوية لحقن كود الـ Sidebar الجانبي التابع لـ menu حياً -->
        ...
        <div class="responsive-profile-wrapper">
            ...
            <div class="profile-sidebar-zone">
                <div class="avatar-wrapper">
                    <!-- تثبيت وضمان إقلاع صورة الأفاتار الصافية من جذر مجلد static وبدون أي حجب سحابي -->
    ...
    <!-- الذيل المغلق الحصين الموحد لحقوق النشر المعتمد برمجياً -->
    <div class="global-footer-bar">
        حقوق النشر محفوظة برمجياً وتعود إلى المسؤول البراوي بتاريخ 2026 ©
    </div>

    <script>
        // الخوارزمية الفائقة لسحب الستارة الجانبية الموحدة من خادم menu.py وحقنها حياً أمام عين الزائر
