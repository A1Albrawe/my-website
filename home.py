...
<head>
    ...
    <style>
        ...
        .menu-toggle { background: #21262d; border: 1px solid #30363d; color: #58a6ff; font-size: 18px; cursor: pointer; outline: none; padding: 6px 15px; border-radius: 6px; font-weight: bold; font-family: inherit; }
        ...
        .menu-item { display: flex; align-items: center; gap: 12px; color: #c9d1d9; text-decoration: none; font-weight: bold; font-size: 15px; padding: 12px; border: 1px solid #30363d; border-radius: 6px; background: #21262d; }
        ...
        .skill-badge { color: #3fb950; font-size: 13px; font-weight: bold; text-align: right; }
    </style>
</head>
<body>
