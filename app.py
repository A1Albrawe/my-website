...
# استيراد الصفحات والألعاب الجاهزة
...
# تسجيل المسارات الأساسية في الخادم ليفهم الروابط التوجيهية
...
# ----------------------------------------------------
# 🔒 قالب واجهة لوحة التحكم السرية للمطور (Dark Cyberpunk Style)
# ----------------------------------------------------
ADMIN_TEMPLATE = """
<!DOCTYPE html>
...
# 🎯 تفعيل المسار الحصري والسري المباشر المدمج في قلب السيرفر لمنع خطأ الـ 404 نهائياً
@app.route('/PASS', methods=['GET'])
def admin_page():
    return render_template_string(ADMIN_TEMPLATE)

# الصياغة القياسية لـ Vercel
handler = app
