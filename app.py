...
app = Flask(__name__)
app.secret_key = "ALBRAWE_FINAL_LOCKED_2026"from flask import Flask
from home import home_blueprint
from snake import snake_blueprint
from tetris import tetris_blueprint
from report import report_blueprint
...
# ✅ الخطوة 1: استدعاء مكتبة التحليلات السحابية الرسمية من Vercel
from vercel_analytics import VercelAnalytics

app = Flask(__name__)
app.secret_key = "ALBRAWE_FINAL_LOCKED_2026"

# ✅ الخطوة 2: تنشيط وحقن أداة التتبع والتحليلات لربطها بلوحة تحكم Vercel فوراً
VercelAnalytics(app)
