...
# عزل التنسيقات الفلورسنتية المتجاوبة تماماً لحماية النواة من الاختناق أو تسريب الأسطر
HOME_CSS = """
<style>
    ...
    /* 🌐 هندسة شبار الإقلاع العلوي المصحح: الاسم يميناً وزر القائمة يساراً بنقاء بصري قياسي */
    ...
    /* 💻 الهيكل ثنائي الأجنحة المطور لتغطية شاشات الكمبيوتر بكفاءة استعراضية فاخرة */
...
<body>
    ...
    <div class="top-nav">
        ...
        <!-- 🎯 التوجيه الهندسي الحاسم: تم حذف السكريبت الجانبي القديم وربط الزر صراحة بمسار /menu الصافي المطور -->
        <a href="/menu" class="menu-btn-link"><i class="fas fa-bars"></i> القائمة</a>
    </div>

    <div class="main-container">
        <!-- الهيكل المزدوج ثنائي الأجنحة الفاخر المحصن للكمبيوتر والموبايل حياً بكفاءة تشغيلية مطلقة -->
        <div class="responsive-profile-wrapper">
            
            <!-- جناح الهوية البصرية الصامتة -->
            <div class="profile-sidebar-zone">
                <div class="avatar-wrapper">
                    <!-- ✅ مواءمة وتثبيت مسار الصورة الصافي والمطابق لصورتك ليتعرف عليه Vercel فوراً ويظهره حياً بدون حجب -->
            ...
            <!-- جناح المحتوى والنبذة والتفاصيل -->
