...
# عزل التنسيقات في كتل نصية رشيقة ومحكمة لمنع خروج الأكواد خارج صناديق النسخ
HOME_CSS = """
<style>
    ...
    /* 🕹️ هندسة الـ Sidebar المنزلق النيوني الفاخر المطابق للصورة تماماً */
    .sidebar-overlay { position: fixed; top: 0; right: -100%; width: 100%; max-width: 290px; height: 100vh; background: rgba(13, 17, 23, 0.96); border-left: 2px solid #58a6ff; box-shadow: -10px 0 30px rgba(0, 0, 0, 0.7); z-index: 9999; display: flex; flex-direction: column; padding: 20px; box-sizing: border-box; transition: right 0.35s cubic-bezier(0.4, 0, 0.2, 1); }
    .sidebar-overlay.active { right: 0; }
    
    .close-menu-btn { background: none; border: none; color: #f85149; font-size: 15px; font-weight: bold; cursor: pointer; display: flex; align-items: center; gap: 5px; align-self: flex-end; margin-bottom: 40px; font-family: inherit; }
    .close-menu-btn:hover { text-shadow: 0 0 8px #f85149; }
    
    .sidebar-links-wrapper { display: flex; flex-direction: column; gap: 24px; text-align: right; padding-right: 10px; }
    
    /* 🎨 ألوان وتنسيقات نصوص الأزرار الفلورسنتية الصافية كما بالبكسل في صورتك */
    .nav-link-item { text-decoration: none; font-size: 14.5px; font-weight: bold; font-family: inherit; transition: 0.2s ease; display: flex; align-items: center; gap: 8px; justify-content: flex-start; }
    
    .link-primary { color: #8b949e; }
    .link-primary:hover { color: #fff; text-shadow: 0 0 5px #fff; }
    
    .link-arcade { color: #3fb950; text-shadow: 0 0 4px rgba(63,185,80,0.2); }
    .link-arcade:hover { text-shadow: 0 0 10px #3fb950; }
    
    .link-projects { color: #a371f7; text-shadow: 0 0 4px rgba(163,113,247,0.2); }
    .link-projects:hover { text-shadow: 0 0 10px #a371f7; }
    
    .link-about { color: #ff7b72; text-shadow: 0 0 4px rgba(255,123,114,0.2); }
    .link-about:hover { text-shadow: 0 0 10px #ff7b72; }
    
    .link-scripts { color: #58a6ff; text-shadow: 0 0 4px rgba(88,166,255,0.2); }
    .link-scripts:hover { text-shadow: 0 0 10px #58a6ff; }
    
    .link-report { color: #ffd700; text-shadow: 0 0 4px rgba(255,215,0,0.2); }
    .link-report:hover { text-shadow: 0 0 10px #ffd700; }
    
    .link-telegram { color: #388bfd; text-shadow: 0 0 4px rgba(56,139,253,0.2); }
    .link-telegram:hover { text-shadow: 0 0 10px #388bfd; }
</style>
"""
HOME_HTML = """
<!DOCTYPE html>
...
<body>
    ...
    <!-- 🌐 شريط التنقل الرئيسي الفخم العلوي الموثوق -->
    <div class="top-nav">
    ...
    <!-- 🕹️ الـ Sidebar المنزلق المضيء المستنسخ من صورتك بالترتيب والامتدادات الصحيحة الموازية للـ Core -->
    <div class="sidebar-overlay" id="slidingSidebarMenu">
        ...
        <div class="sidebar-links-wrapper">
            <!-- 🔗 تم ربط وتعديل روابط كافة الرموز والصفحات لتتطابق تماماً مع النواة والامتدادات الرسمية لعام 2026 -->
            <a href="/" class="nav-link-item link-primary">البوابة الرئيسية</a>
            <a href="/arcade" class="nav-link-item link-arcade">قائمة ألعاب النظام 🎮</a>
            <a href="/projects" class="nav-link-item link-projects">معرض المشاريع</a>
            <a href="/about" class="nav-link-item link-about">(About us)</a>
            <a href="/scripts" class="nav-link-item link-scripts">إسكربتات بايثون</a>
            <a href="/report" class="nav-link-item link-report">الإبلاغ عن مشكلة (صيانة)</a>
            <a href="https://t.me" target="_blank" class="nav-link-item link-telegram">حسابي في التليجرام</a>
        </div>
    </div>

    <div class="main-container">
        <!-- 🛡️ كرت هويتك الشخصي الرقمي والنبذة الفخمة المتناسقة -->
    ...
    <script>
        // دالة سريعة وموفرة للطاقة لفتح وغلق ستاير القائمة الجانبية بنسق انسيابي مبهر جداً للموبايل
