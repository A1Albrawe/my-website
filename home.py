...
<body>
    ...
    <div class="sidebar-curtain" id="sidebarCurtain">
        ...
        <div class="menu-links">
            ...
            <!-- 🎯 تم دمج وإضافة خانة إسكربتات بايثون الجديدة داخل القائمة الجانبية بنجاح -->
