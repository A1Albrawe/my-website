...
from menu import generate_sidebar_html # استدعاء دالة توليد القائمة ديناميكياً

home_blueprint = Blueprint('home', __name__)

def get_home_template():
    # جلب كود الـ HTML الخاص بالروابط من ملف menu.py وتضمينه داخل الستارة
    sidebar_menu_html = generate_sidebar_html()
...
<head>
    ...
    <style>
        ...
        .menu-toggle {{ background: #21262d; border: 1px solid #30363d; color: #58a6ff; font-size: 20px; cursor: pointer; outline: none; padding: 6px 15px; border-radius: 6px; transition: 0.2s; font-family: inherit; font-weight: bold; }}
        ...
        .menu-item {{ display: flex; align-items: center; gap: 12px; text-decoration: none; font-weight: bold; font-size: 15px; padding: 12px; border: 1px solid #30363d; border-radius: 6px; background: #21262d; transition: all 0.2s ease; }}
        .menu-item:hover {{ border-color: #58a6ff; background: rgba(88, 166, 255, 0.05); transform: translateX(-5px); }}
    ...
    <div class="main-container">
        <div class="dev-portfolio-card">
            ...
            <div class="info-section">
                ...
                <div style="color: #3fb950; font-size: 13px; font-weight: bold; text-align: right; margin-top: 6px;">🔹 Python (Flask)</div>
                <div style="color: #3fb950; font-size: 13px; font-weight: bold; text-align: right; margin-top: 6px;">🔹 JavaScript (ES6)</div>
            </div>
        </div>
    </div>
...
def home_page():
    return render_template_string(get_home_template())
