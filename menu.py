...
# عزل تنسيقات الـ Sidebar المنزلق لتجنب تداخل الأقواس وانهيار السيرفر
MENU_CSS = """
<style>
...
def get_sidebar_menu():
    # 🧠 محرك التصفية السيبرانية: بتر وسحق الـ n\ والـ Spaces قسراً من جذر الملف النصي لمنع الـ 404
    games_list_nodes = []
    try:
