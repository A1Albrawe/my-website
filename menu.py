...
def generate_sidebar_html():
    ...
    # 🎯 محرك قراءة الألعاب التلقائي الحصري من مجلد static/my_games
    ...
    if os.path.exists(folder_path):
        for file_name in sorted(os.listdir(folder_path)):
            if file_name.endswith('.txt'):
                ...
                # استخراج اسم المسار من اسم الملف
    ...
    <style>
        ...
        .dropdown-toggle-btn-clean {{ width: 100%; text-align: right; display: flex; justify-content: space-between; align-items: center; cursor: pointer; background: transparent; border: 1px solid transparent; padding: 10px 12px; border-radius: 6px; font-weight: bold; font-family: inherit; color: #3fb950; transition: all 0.2s ease; box-sizing: border-box; }}
    ...
    <div class="sidebar-links-wrapper">
        ...
        <!-- 🎮 خانة الألعاب الديناميكية الحصرية (تقرأ كلياً وفوراً من مجلد static/my_games) -->
        ...
        <!-- 📂 بقية الخانات ثابتة التوجيه وتعمل من الجذر مباشرة دون تغيير مكانها -->
